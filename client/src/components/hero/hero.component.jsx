...
const Hero = () => {
  ...
  return (
     ...
     <div
    className="relative -mt-32 mb-6 z-0 overflow-hidden bg-cover bg-no-repeat h-screen w-screen z-10">
    ...
    <div
      className="absolute top-0 right-0 bottom-0 left-0 h-full w-full overflow-hidden bg-fixed bg-[rgba(255,255,255,0.45)]">
      <div className="z-10 flex flex-col h-full items-center justify-center">
        <div className="flex flex-row items-center max-w-[80vw] justify-center space-x-8 h-1/2 px-6 text-center text-slate-700 md:px-12">
				<img src={Logo} alt="glowing-flowers" className="my-0 mx-auto h-auto z-10"/>
          <h1 className="z-10 mt-12 mb-12 text-5xl text-left font-medium tracking-none transform -skew-x-12 md:text-5xl xl:text-6xl">
            Artisanal flower arrangements made at the <br /><span className="text-rose-500">heart</span>{' '}of San Francisco
          </h1>
        </div>
				<div className="flex flex-row items-center justify-evenly">
          <a className="mb-2 inline-block rounded-full border-2 border-rose-800 px-[46px] pt-[14px] pb-[12px] text-3xl font-medium uppercase leading-normal text-rose-800 transition duration-150 ease-in-out hover:border-rose-100 hover:bg-rose-500 hover:bg-opacity-10 hover:text-rose-50 focus:border-rose-100 focus:text-rose-100 focus:outline-none focus:ring-0 active:border-rose-200 active:text-rose-200 md:mr-2 md:mb-0 z-10"
            data-te-ripple-init data-te-ripple-color="light" href="#!" role="button">Shop Now</a>
          <a className="inline-block rounded-full px-12 pt-4 pb-3.5 text-3xl font-medium uppercase leading-normal text-rose-800 transition duration-150 ease-in-out hover:bg-rose-800 hover:bg-opacity-20 hover:text-rose-200 focus:text-rose-200 focus:outline-none focus:ring-0 active:text-rose-300 z-10"
            data-te-ripple-init data-te-ripple-color="light" href="#!" role="button">Sign In</a>
						</div>
      </div>
  </div>
  <div
    className="-mt-2.5 text-white dark:text-rose-800 md:-mt-4 lg:-mt-6 xl:-mt-10 h-[50px] scale-[2] origin-[top_center]">
