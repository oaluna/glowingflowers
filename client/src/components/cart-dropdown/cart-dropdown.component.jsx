...
const CartDropdown = ({ cartItems, history, dispatch }) => {
  ...
  return (
    <div className="absolute w-[400px] h-[480px] flex flex-col bg-rose-50 p-[15px] border border-solid border-gray-50/20 top-[90px] right-[40px] z-10 text-slate-900 shadow-xl z-20">
